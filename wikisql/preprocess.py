...
parser.add_argument('-train_anno', default="../data/wikisql/annotated_ent/train.jsonl",
                    help="Path to the training annotated data")
parser.add_argument('-valid_anno', default="../data/wikisql/annotated_ent/dev.jsonl",
                    help="Path to the validation annotated data")
parser.add_argument('-test_anno', default="../data/wikisql/annotated_ent/test.jsonl",
